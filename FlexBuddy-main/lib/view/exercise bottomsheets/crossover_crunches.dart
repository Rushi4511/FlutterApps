...
class CrossoverCrunches extends StatelessWidget {
  static void show(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (context) => const Material(
        ...
        child: CrossoverCrunches(),
      ),
    );
  }

  const CrossoverCrunches({super.key});
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Image.asset(
                            'assets/images/exercise_gif/crossover_crunch.gif',
                            height: 270,
