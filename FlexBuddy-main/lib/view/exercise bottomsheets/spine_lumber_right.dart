...
class SpineLumberRight extends StatelessWidget {
  static void show(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (context) => const Material(
        ...
        child: SpineLumberRight(),
      ),
    );
  }

  const SpineLumberRight({super.key});
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Image.asset(
                            'assets/images/exercise_gif/spine_lumber_twist_stretch_right.gif',
                            height: 280,
                          ...
                          ClipRRect(
                            ...
                            child: Image.asset(
                              "assets/images/exercise_body/Body10.jpg",
                            ),
                          ),
