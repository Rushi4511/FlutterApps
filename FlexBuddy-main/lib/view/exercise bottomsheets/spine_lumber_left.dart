...
class SpineLumberLeft extends StatelessWidget {
  static void show(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (context) => const Material(
        ...
        child: SpineLumberLeft(),
      ),
    );
  }

  const SpineLumberLeft({super.key});
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      const Expanded(
                        child: Text(
                          'SPINE LUMBER TWIST STRETCH LEFT',
                          style: TextStyle(
                              fontSize: 20,
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Image.asset(
                            'assets/images/exercise_gif/spine_lumber_twist_stretch_left.gif',
                            height: 280,
                          ...
                          Wrap(
                            ...
                            children: [
                              ...
                              _buildFocusChip('Glutes', true),
                              _buildFocusChip('Back', true),
                              _buildFocusChip('Traps', true),
                            ],
                          ),
                          const SizedBox(height: 24),
                          ClipRRect(
                            ...
                            child: Image.asset(
                              "assets/images/exercise_body/Body7.jpg",
                            ),
                          ),
