...
class PushupAndRotation extends StatelessWidget {
  static void show(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (context) => const Material(
        ...
        child: PushupAndRotation(),
      ),
    );
  }

  const PushupAndRotation({super.key});
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Image.asset(
                            'assets/images/exercise_gif/push_up_and_rotation.gif',
                            height: 270,
                          ...
                          Wrap(
                            ...
                            children: [
                              ...
                              _buildFocusChip('Quadriceps', true),
                              _buildFocusChip('Adductors', true),                              
                            ],
                          ),
                          const SizedBox(height: 24),
                          ClipRRect(
                            ...
                            child: Image.asset(
                              "assets/images/exercise_body/Body1.jpg",
                            ),
                          ),
