...
class LegsIntermediateModel {
  final String name;
  final String count;
  final String imagePath;

  LegsIntermediateModel({
    required this.name,
    required this.count,
...
class LegsIntermediateScreen extends StatelessWidget {
  const LegsIntermediateScreen({super.key});

  final bool exerciseStarted = false;
  @override
  Widget build(BuildContext context) {
    // List of exercises
    final List<LegsIntermediateModel> exercises = [
      LegsIntermediateModel(
        name: 'Side Hop',
        count: '00:30',
