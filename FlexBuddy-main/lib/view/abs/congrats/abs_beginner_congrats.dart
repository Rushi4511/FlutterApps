...
class AbsBeginnerCongratsScreen extends StatefulWidget {
  final int exercisesCompleted;
  final int totalCalories;
  final int totalMinutes;
  const AbsBeginnerCongratsScreen(
      {super.key,
  ...
  @override
  State<AbsBeginnerCongratsScreen> createState() =>
      _AbsBeginnerCongratsScreenState();
}

class _AbsBeginnerCongratsScreenState extends State<AbsBeginnerCongratsScreen>
