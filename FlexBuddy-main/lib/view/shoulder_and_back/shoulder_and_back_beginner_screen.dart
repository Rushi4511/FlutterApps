...
class ShoulderAndBackBeginnerModel {
  final String name;
  final String count;
  final String imagePath;

  ShoulderAndBackBeginnerModel({
    required this.name,
    required this.count,
...
class ShoulderAndBackBeginnerScreen extends StatelessWidget {
  const ShoulderAndBackBeginnerScreen({super.key});

  final bool exerciseStarted = false;
  @override
  Widget build(BuildContext context) {
    // List of exercises
    final List<ShoulderAndBackBeginnerModel> exercises = [
      ShoulderAndBackBeginnerModel(
        name: 'Jumping Jacks',
        count: '00:30',
