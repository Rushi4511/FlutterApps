...
class ShoulderAndBackAdvancedModel {
  final String name;
  final String count;
  final String imagePath;

  ShoulderAndBackAdvancedModel({
    required this.name,
    required this.count,
...
class ShoulderAndBackAdvancedScreen extends StatelessWidget {
  const ShoulderAndBackAdvancedScreen({super.key});

  final bool exerciseStarted = false;
  @override
  Widget build(BuildContext context) {
    // List of exercises
    final List<ShoulderAndBackAdvancedModel> exercises = [
      ShoulderAndBackAdvancedModel(
        name: 'Jumping Jacks',
        count: '00:30',
